  ...
  describe "the print method" do
    ...
    describe "lists" do
      ...
      it "should print one-element lists" do
        ...
        Piret.print(Piret::Cons[Piret::Keyword[:raaaaash]]).should eq \
            "(:raaaaash)"
      end

      it "should print multiple-element lists" do
        Piret.print(Piret::Cons[1, 2, 3]).should eq "(1 2 3)"
        Piret.print(Piret::Cons[:true, Piret::Cons[], [], "no"]).should eq \
            "(true () [] \"no\")"
      end
      ...
      it "should print nested lists" do
        Piret.print(Piret::Cons[Piret::Cons[Piret::Cons[3], 
                    ...
                    Piret::Cons[Piret::Cons[8], Piret::Cons[8]]]).should eq \
            "(((3) (())) 9 ((8) (8)))"
      end
    end
    ...
    describe "vectors" do
      ...
      it "should print multiple-element vectors" do
        ...
        Piret.print([:true, Piret::Cons[], [], "no"]).should eq \
            "[true () [] \"no\"]"
      end

      it "should print nested vectors" do
        Piret.print([[[3], [[]]], 9, [[8], [8]]]).should eq \
            "[[[3] [[]]] 9 [[8] [8]]]"
      end
    end
    ...
    it "should print builtin forms in their namespace" do
      Piret.print(Piret::Builtin[Piret::Eval::Builtins.method(:let)]).should \
          eq "piret/let"
      Piret.print(Piret::Builtin[Piret::Eval::Builtins.method(:def)]).should \
          eq "piret/def"
    end
